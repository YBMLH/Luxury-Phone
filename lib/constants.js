...
export const CATEGORIES = [
  ...
  { id: 'smart-watches', label: 'Smart Watches', icon: '⌚' },
  { id: 'headphones', label: 'Headphones', icon: '🎧' },
  { id: 'chargers', label: 'Chargers', icon: '🔌' },
  { id: 'phone-cases', label: 'Phone Cases', icon: '📳' },
  { id: 'gaming-accessories', label: 'Gaming Accessories', icon: '🎮' },
  { id: 'computer-accessories', label: 'Computer Accessories', icon: '🖱️' },
  { id: 'other-electronics', label: 'Other Electronics', icon: '⚡' },
];
...
// All 58 Algerian wilayas, in official order.
