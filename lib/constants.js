...
// Opening hours in the shape Schema.org wants, so Google can show
// "Open now · closes 22:00" on the shop's map listing. The sentence in
// Settings is what a human reads; this is what a machine reads, and the two
// have to be kept in step by hand — a free-text field can't be parsed
// reliably enough to generate this from it.
// Friday is simply absent, which is how Schema.org expresses "closed".
...
export const SOCIAL_FALLBACK = {
  ...
  tiktok: 'https://www.tiktok.com/@luxury_phone4',
};
