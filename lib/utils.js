...
// Picks which products appear in the hero device fan: featured ones first,
// then the newest others, skipping anything without a photo. Shared by the
// server render (app/(store)/page.js) and the live client refresh
// (HomeClient) so both always agree on the same set.
